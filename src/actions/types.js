...
export const User_Bnb_Balance = "User_Bnb_Balance";
export const User_Eth_Balance = "User_Eth_Balance";
export const Injected_Wallet = "Injected_Wallet";
export const Tx_Processing = "Tx_Processing";
